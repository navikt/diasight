...
import { IAppointment, IBundle, IDiagnosticReport, IMedicationRequest, IObservation, IPractitioner, IQuestionnaireResponse, IReference, IServiceRequest } from "@ahryman40k/ts-fhir-types/lib/R4";
